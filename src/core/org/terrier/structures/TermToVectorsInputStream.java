 ...
 * under the License.
 *
 * The Original Code is TermToVectorsInputStream.java.
 *
 ...
 */
public class TermToVectorsInputStream extends BitPostingIndexInputStream {
	
	protected TermToVectorsInputStream(Index _index, String structureName, 
	...
	public TermToVectorsInputStream(Index index, String structureName, Class<? extends IterablePosting> postingIterator) throws IOException
	{
	 ...
	 */
	@SuppressWarnings("unchecked")
	public TermToVectorsInputStream(Index index, String structureName) throws IOException
	{
	...
	/*
		{
			termId1: [vector1, vector2]
		}
	*/
	public HashMap<int, Vector[]> getNextTerms() throws IOException {
// @TODO
	}
...
// @TODO
	...
	protected DocumentIndex getDocumentIndex(BitIndexPointer pointer) {
		// return new BitPostingIndex.DocidSpecificDocumentIndex(null, (DocumentIndexEntry) pointer);
		// @TODO
	}
}
