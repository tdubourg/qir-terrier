 ...
 * under the License.
 *
 * The Original Code is TermToVectorsOutputStream.java.
 *
...
/** Writes a block direct or block inverted index, when passed appropriate posting lists.
  ...
  * @since 2.0
  */
public class TermToVectorsOutputStream implements Closeable {
	/** what to write to */
	protected BitOut output;
	/** The logger used */
	protected static final Logger logger = Logger.getLogger(TermToVectorsOutputStream.class);
	...
	/** Creates a new output stream, writing a BitOutputStream to the specified file. The number of binary bits
	  ...
	  */
	public TermToVectorsOutputStream(String filename) throws IOException
	{
	...
	/** Creates a new output stream, writing to the specified BitOut implementation.  The number of binary bits
	  ...
	  */
	public TermToVectorsOutputStream(BitOut out)
	{
		this.output = out;
	}
