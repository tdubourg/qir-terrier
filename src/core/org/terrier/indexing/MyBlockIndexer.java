 ...
 * under the License.
 *
 * The Original Code is MyBlockIndexer.java.
 *
 ...
 */
public class MyBlockIndexer extends Indexer {
	...
	protected class BasicTermProcessor implements TermPipeline {
		public BasicTermProcessor() {
			System.out.println("@@ Instanciating a new BasicTermProcessor");
		}
		...
		public void processTerm(String term) {
			...
			if (term != null) {
				...
				System.out.println("@ Inserting (\"" + term + "\", " + blockId + ") into the document's terms.");
				((BlockDocumentPostingList)termsInDocument).insert(term, blockId);
	...
	protected class FieldTermProcessor implements TermPipeline {
		...
		public FieldTermProcessor() {
			System.out.println("@@ Instanciating a new FieldTermProcessor");
		}
	 ...
	 * absolute.
	  ...
	  */
	public MyBlockIndexer(String pathname, String prefix) {
		super(pathname, prefix);
		if (this.getClass() == MyBlockIndexer.class)
			init();
	...
	public void createDirectIndex(Collection[] collections) {
		logger.info("MyBlockIndexer creating direct index"+ 
